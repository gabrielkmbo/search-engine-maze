...
STUDENT_TEST("duplicateNegatives, input has repeated negative numbers")
{
    Queue<int> q = {-1, -1};
...
STUDENT_TEST("duplicateNegatives, input has many negative numbers")
{
    Queue<int> q = {-1, -2, -1, -2};
    Queue<int> expected = {-1, -1, -2, -2, -1, -1, -2, -2};
    duplicateNegatives(q);

    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, input has only one negative number")
{
    Queue<int> q = {-1};
